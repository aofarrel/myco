...
## Units for disk size
Unless otherwise specified, user-facing storage units are in gigabytes. For example, the variant caller's additional disk arg being 100 is interpreted as "add 100 GB to the disk calculation."

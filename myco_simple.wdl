...
workflow myco {
	input {
		...
		Int     max_low_coverage_sites =  20  # you may want to experiment with 5
	...
	parameter_meta {
		...
		max_low_coverage_sites: "If a diff file has higher than this percent (50 = 50%) bad data, do not include it in the tree"

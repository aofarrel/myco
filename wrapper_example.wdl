...
import "./myco_simple.wdl" as main
...
#
# However, you don't need to use this wrapper at all. You could still use the above Terra data table with myco_simple by entering
# your samples like this on Terra:
#
# Array[Array[File]] paired_decontaminated_fastq_sets = [[this.decontaminated_fastq_1, this.decontaminated_fastq_2]]
# 
# There may be some edge cases two different File inputs are preferred, so I'll keep this up, but it's not officially supported.
